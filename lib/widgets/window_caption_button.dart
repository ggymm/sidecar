...
class WindowCaptionButtonIcon extends StatelessWidget {
  const WindowCaptionButtonIcon({super.key, required this.name, this.color});
...
class WindowCaptionButton extends StatefulWidget {
  ...
  WindowCaptionButton.close({
    ...
    this.icon,
    this.onPressed,
  }) : iconName = 'assets/icons/ic_chrome_close.png',
  ...
  WindowCaptionButton.unmaximize({
    ...
    this.icon,
    this.onPressed,
  }) : iconName = 'assets/icons/ic_chrome_unmaximize.png';
  ...
  WindowCaptionButton.maximize({
    ...
    this.icon,
    this.onPressed,
  }) : iconName = 'assets/icons/ic_chrome_maximize.png';
  ...
  WindowCaptionButton.minimize({
    ...
    this.icon,
    this.onPressed,
  }) : iconName = 'assets/icons/ic_chrome_minimize.png';
